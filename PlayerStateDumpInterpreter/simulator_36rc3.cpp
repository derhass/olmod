...
Olmod36RC3::Olmod36RC3(ResultProcessor& rp) :
	Cow1(rp),
	mms_ship_lag_compensation_added_lag(0.0f),
	fixedDeltaTime(1.0f/60.0f)
{
	cfg.Add(ConfigParam(mms_ship_lag_compensation_added_lag,"added_lag", "lag"));

	instrp[INSTR_HARD_SYNC].name = "36RC3_HARD_SYNC";
	instrp[INSTR_SOFT_SYNC].name = "36RC3_SOFT_SYNC";
	instrp[INSTR_INTERPOLATE].name = "36RC3_INTERPOLATE";
	instrp[INSTR_INTERPOLATE_01].name = "36RC3_INTERPOLATE_01";
	instrp[INSTR_INTERPOLATE_12].name = "36RC3_INTERPOLATE_12";
	instrp[INSTR_INTERPOLATE_23].name = "36RC3_INTERPOLATE_23";
	instrp[INSTR_EXTRAPOLATE].name = "36RC3_EXTRAPOLATE";
	instrp[INSTR_EXTRAPOLATE_PAST].name = "36RC3_EXTRAPOLATE_PAST";
}

Olmod36RC3::~Olmod36RC3()
{
}

const char *Olmod36RC3::GetBaseName() const
{
	return "olmod-0.3.6-rc3";
}

void Olmod36RC3::EnqueueToRing(const PlayerSnapshotMessage& msg)
{
...
void Olmod36RC3::ResetForNewMatch()
{
	ClearRing();
...
void Olmod36RC3::AddNewPlayerSnapshot(const PlayerSnapshotMessage& msg)
{
...
bool Olmod36RC3::DoInterpolation(const InterpolationCycle& interpolationInfo, InterpolationResults& results)
{
	...
	*/
	...
	delta_t -= (mms_ship_lag_compensation_added_lag / 1000.0f) * interpolationInfo.timeScale;
...
void Olmod36RC3::interpolatePlayer(const PlayerSnapshot& A, const PlayerSnapshot& B, PlayerSnapshot& result, float t)
{
	result.id = A.id;
