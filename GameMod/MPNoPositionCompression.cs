...
namespace GameMod {
    ...
    public class MPNoPositionCompression {
        ...
        // which version the NewPlayerSnapshotToClientMessages we process are
        // set it to the default of 0.3.6/0.3.7 server where we can't trust the
        // message timestamps. This might be updated by MPTweaks later on if the
        // server sends reliable timestamps.
